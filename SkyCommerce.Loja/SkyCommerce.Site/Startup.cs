...
namespace SkyCommerce.Site
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            JwtSecurityTokenHandler.DefaultMapInboundClaims = false; // aspnet core não associar os schemas xml aos nomes default das claims
            if (Debugger.IsAttached)
                IdentityModelEventSource.ShowPII = true; // caso der erro, faz debug
            ...
            services.AddAuthentication(options =>
                ...
                .AddOpenIdConnect("oidc", options =>
                {
                    ...
                    options.ClientId = "c9cc9589e4e64b19821ab53de5bd168f"; //"715000d0c10040258c1be259c09e3b91";
                    options.ClientSecret = "6f4db70f54cd43359332172f03e06abc";// "360ceac2e80545dca6083fef4f94d09f";
